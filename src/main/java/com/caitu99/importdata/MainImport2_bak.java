...
public class MainImport2_bak {
    private static final Logger logger = LoggerFactory.getLogger(MainImport2_bak.class);
    ...
    public static void main(String[] args) throws Exception {
        InputStream inputStream = MainImport2_bak.class.getClassLoader().getResourceAsStream("log4j.properties");
