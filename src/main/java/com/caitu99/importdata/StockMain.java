...
public class StockMain {
    ...
    public static void importDataToSQLFile() throws Exception {
        ...
        OutputStream outputStream = new FileOutputStream("F:\\stock.sql");
        //加载xlsx文件
        InputStream inputStream = new FileInputStream("E:\\msg\\商品V5.0\\第一批商品列表.xlsx");
