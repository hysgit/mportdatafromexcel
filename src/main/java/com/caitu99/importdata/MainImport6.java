...
public class MainImport6 {
    private static final Logger logger = LoggerFactory.getLogger(MainImport6.class);
    ...
    public static void main(String[] args) throws Exception {
        InputStream inputStream = MainImport6.class.getClassLoader().getResourceAsStream("log4j.properties");
