...
public class MainImport4 {
    private static final Logger logger = LoggerFactory.getLogger(MainImport4.class);
    ...
    public static void main(String[] args) throws Exception {
        InputStream inputStream = MainImport4.class.getClassLoader().getResourceAsStream("log4j.properties");
